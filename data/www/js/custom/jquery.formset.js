        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                template.find('input,select,textarea,label').each(function() {
                    ...
                    // Qing's Note:
                    // If this is a textarea, set empty value to it.
                    // This fixes Issue 11, reported by Direly
                    // This issue only comes with JQuery.1-6-2
                    // CODE ADDED by Qing ->
                ...
                // Qing's Note:
                // If there are error list in the last form,
                // do NOT clone it in the added extra form.
                // CODE ADDED by Qing ->
